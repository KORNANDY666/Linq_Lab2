...
namespace Linq_Lab2.Data.Migrations
{
    ...
    [Migration("20230421121125_second")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Linq_Lab2.Models.Course", b =>
                {
            ...
            modelBuilder.Entity("Linq_Lab2.Models.SchoolClass", b =>
                {
            ...
            modelBuilder.Entity("Linq_Lab2.Models.SchoolConnection", b =>
                {
                    ...
                    b.ToTable("SchoolConnection");
                });

            modelBuilder.Entity("Linq_Lab2.Models.Student", b =>
                {
            ...
            modelBuilder.Entity("Linq_Lab2.Models.Teacher", b =>
                {
            ...
            modelBuilder.Entity("Linq_Lab2.Models.SchoolConnection", b =>
                {
                    b.HasOne("Linq_Lab2.Models.Course", "Courses")
                        .WithMany("SchoolConnections")
                        .HasForeignKey("FK_CourseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Linq_Lab2.Models.SchoolClass", "SchoolClasses")
                        .WithMany("SchoolConnections")
                        .HasForeignKey("FK_SchoolClassId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Linq_Lab2.Models.Student", "Students")
                        .WithMany("SchoolConnections")
                        .HasForeignKey("FK_StudentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Linq_Lab2.Models.Teacher", "Teachers")
                        .WithMany("SchoolConnections")
